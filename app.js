...
document.querySelector("#korea").addEventListener("click", listKorea)
...
document.querySelector("#japan").addEventListener("click", listJapan)
...
document.querySelector("#china").addEventListener("click", listChina);
